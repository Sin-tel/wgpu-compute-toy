        ...
        Blitter {
            render_bind_group: wgpu.device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    ...
                    wgpu::BindGroupEntry {
                        binding: 1,
                        resource: wgpu::BindingResource::Sampler(&wgpu.device.create_sampler(
            ...
            render_pipeline: wgpu
                ...
                .create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                    ...
                    fragment: Some(wgpu::FragmentState {
                        module: &render_shader,
                        entry_point: match dest_format {
                            // FIXME use sRGB viewFormats instead once the API stabilises
                            wgpu::TextureFormat::Bgra8Unorm => "fs_main_linear_to_srgb",
                            wgpu::TextureFormat::Rgba8Unorm => "fs_main_linear_to_srgb",
                            wgpu::TextureFormat::Bgra8UnormSrgb => "fs_main", // format automatically performs sRGB encoding
                            wgpu::TextureFormat::Rgba8UnormSrgb => "fs_main",
                            wgpu::TextureFormat::Rgba16Float => "fs_main",
                            _ => panic!("Blitter: unrecognised conversion to {dest_format:?}"),
                        },
